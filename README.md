...
│   ├── rzd_functions.py # отбор важный частей аудио и расчет метрик
├── rzd_utils # вспомогательный пакет проекта, предназначенный для использования при обучении
...
├── Ноутбук_с_обучением.ipynb # обучение wav2vec модели
...
├── onnx_weights.txt # аналогичный файл, но ссылка на квантизованные веса с помощью onnx
├── README.md
```
